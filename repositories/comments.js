import { Comments, INCLUDE_USER, ORDER_DESC } from '../model/comments.js';
...
class CommentRepository {
  ...
  getById = async (commentId) => {
    return await Comments.findOne({ where: { commentId }, ...INCLUDE_USER });
  };
  ...
  commentRemove = async (commentId) => {
    return Comments.findByPk(commentId).then((comment) => {
